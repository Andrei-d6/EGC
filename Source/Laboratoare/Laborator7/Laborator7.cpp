...
void Laborator7::Update(float deltaTimeSeconds)
{
...

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.1f, 0.33f, 0.7f));
	}
	...
	// Render ground
	{
		...
		RenderSimpleMesh(meshes["plane"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.3, 0.2, .17));
	}
	...
	// Render the point light in the scene
	{
		...
		time = time + sign * 0.2f * deltaTimeSeconds;
		glm::mat4 modelMatrix = glm::mat4(1);
		modelMatrix = glm::translate(modelMatrix, lightPosition);
		modelMatrix = glm::scale(modelMatrix, glm::vec3(0.1f));
		RenderSimpleMesh(meshes["sphere"], shaders["ShaderLab7"], modelMatrix, glm::vec3(time, 1 - time, 1 - time));
